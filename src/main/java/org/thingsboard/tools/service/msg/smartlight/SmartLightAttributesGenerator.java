...
public class SmartLightAttributesGenerator extends BaseSmartLightGenerator implements MessageGenerator {
    ...
    public Msg getNextMessage(String deviceName, boolean shouldTriggerAlarm) {
        ...
        try {
            ...
            values.put("model", "SL-100");
            values.put("firmwareVersion", "1.2.3");
